...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      ...
      type: "website",
      images: [
        "https://www.edcwebdesign.com/assets/about/garret_head_waterfall.jpg",
      ],
    },
    twitter: {
...
function getAboutJsonLd() {
  return {
    "@context": "https://schema.org",
    "@type": "AboutPage",
    "@id": "https://www.edcwebdesign.com/about",
    name: "About EDC Web Design",
    url: "https://www.edcwebdesign.com/about",
    mainEntityOfPage: {
      "@type": "LocalBusiness",
...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Script
        id="jsonld-about-edc-web-design"
